 ...
 */
class getForecastRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ForecastRepository' shared autowired service.
     *
     * @return \App\Repository\ForecastRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ForecastRepository.php';

        return $container->privates['App\\Repository\\ForecastRepository'] = new \App\Repository\ForecastRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
